    ...
    OOCarousel.FX = {
        ...
        SLIDE: function (carousel, from, to) {
            ...
            if (Math.abs(from - to) === $items.length - 1) {
                ...
                carousel.$list.stop().css({ left: '+=' + itemsWidth * leftOrRight + 'px' });
                carousel.clones.$before.stop().css({ left: '+=' + itemsWidth * leftOrRight + 'px' });
                carousel.clones.$after.stop().css({ left: '+=' + itemsWidth * leftOrRight + 'px' });
            } else {
